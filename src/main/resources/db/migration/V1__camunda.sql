--- Below scripts are copied from camunda-engine 7.11.1.

--- 1. copied from activiti.postgres.create.engine.sql
...
--- 2. copied from activiti.postgres.create.identity.sql
...
--- 3. Copied from activiti.postgres.create.history.sql
...
--4.  copied from activiti.postgres.create.decision.engine.sql
...
--- 5. copied from activiti.postgres.create.decision.history.sql
...
--6. copied from activiti.postgres.create.case.engine.sql
...
--7 Copied from activiti.postgres.create.case.history.sql
